...
import '../module_resturants/restaurant_module.dart' as _i24;
import '../module_resturants/state_manager/restaurants_state_manager.dart'
    as _i19;
import '../module_resturants/ui/screens/restaurant_screen.dart' as _i20;
import '../module_settings/settings_module.dart' as _i21;
import '../module_settings/ui/settings_page/settings_page.dart' as _i16;
import '../module_splash/splash_module.dart' as _i22;
import '../module_splash/ui/screen/splash_screen.dart' as _i17;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i17.SplashScreen>(
      () => _i17.SplashScreen(get<_i14.AuthService>()));
  gh.factory<_i18.LoginStateManager>(() => _i18.LoginStateManager(
        get<_i14.AuthService>(),
        get<_i15.RestaurantRepository>(),
        get<_i3.AuthPrefsHelper>(),
      ));
  gh.factory<_i19.RestaurantCubit>(
      () => _i19.RestaurantCubit(get<_i15.RestaurantRepository>()));
  gh.factory<_i20.RestaurantsScreen>(() => _i20.RestaurantsScreen(
        get<_i19.RestaurantCubit>(),
        get<_i3.AuthPrefsHelper>(),
      ));
  gh.factory<_i21.SettingsModule>(
      () => _i21.SettingsModule(get<_i16.SettingsScreen>()));
  gh.factory<_i22.SplashModule>(
      () => _i22.SplashModule(get<_i17.SplashScreen>()));
  gh.factory<_i23.LoginScreen>(
      () => _i23.LoginScreen(get<_i18.LoginStateManager>()));
  gh.factory<_i24.RestaurantsModule>(
      () => _i24.RestaurantsModule(get<_i20.RestaurantsScreen>()));
  gh.factory<_i25.AuthorizationModule>(() => _i25.AuthorizationModule(
        get<_i23.LoginScreen>(),
        get<_i9.WelcomePage>(),
      ));
  gh.factory<_i26.MyApp>(() => _i26.MyApp(
        ...
        get<_i24.RestaurantsModule>(),
        get<_i21.SettingsModule>(),
      ));
  return get;
}
